...
/**
 * @param {string[]} args
 * @param {{ cwd: string, input?: string, timeoutMs?: number, extraEnv?: Record<string, string>, extraPath?: string }} opts
 */
...
function runVercel(args, opts) {
  const { cwd, homeDir = cwd, input, timeoutMs = 60_000, extraEnv = {}, extraPath } = opts;
